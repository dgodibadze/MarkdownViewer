...
just be consistent). Save/rename the PNGs into this folder with these exact names.
...
- Keep the window around **900×760** (the default) so shots are comparable.
- Cycle the theme with the circular toolbar button (Light → Dark → System).
- Re-capture after UI changes — a stale screenshot is worse than none.
- Shots may come from either platform; note it in the main README caption if
  you switch (Windows equivalents: `Ctrl+3`, `Ctrl+1`, `Ctrl+H`, Help ▸ About).
